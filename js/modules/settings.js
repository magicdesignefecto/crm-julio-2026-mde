...
export const SettingsModule = {
        ...
        return `
            ...
            <div class="settings-container">
                ...
                <div class="section-header">
                    <h3><i class="fas fa-user-clock" style="color:#F59E0B;"></i> Solicitudes de Acceso Pendientes</h3>
                </div>
    ...
    init: async () => {
        ...
        try {
            ...
            if (container) {
                if (pendingUsers.length === 0) {
                    ...
                    container.innerHTML = pendingUsers.map(u => `
                        <div class="user-card">
                            <div class="u-info">
                                <div class="u-avatar">${(u.name || 'U').charAt(0).toUpperCase()}</div>
                                <div>
                            ...
                            <div class="u-actions">
                                <button class="btn-approve" onclick="approveUser('${u.id}', '${(u.name || '').replace(/'/g, "\\'")}')">
            ...
            const container = document.getElementById('pendingUsersContainer');
            if (container) {
                container.innerHTML = '<div class="empty-state-mini"><p style="color:#EF4444;">Error al cargar solicitudes.</p></div>';
            }
        }
        ...
        window.saveProfile = async () => {
            ...
            try {
                ...
                Store.setUser({ ...currentUser, name, role });
            } catch (e) {
                ...
                if (file) {
                    ...
                    try {
                        ...
                        if (user) {
                            ...
                            const currentUser = Store.getState().user;
                            Store.setUser({ ...currentUser, photoURL: compressedBase64 });
