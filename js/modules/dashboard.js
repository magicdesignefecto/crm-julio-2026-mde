...
export const DashboardModule = {
    render: async () => {
        return `
            <style>
                ...
                /* CEO Card Colors */
                .stat-card.ceo-green::before { background: linear-gradient(90deg, #10B981, #34D399); }
                .stat-card.ceo-orange::before { background: linear-gradient(90deg, #F97316, #FB923C); }
                .stat-card.ceo-red::before { background: linear-gradient(90deg, #EF4444, #F87171); }
                .stat-card.ceo-yellow::before { background: linear-gradient(90deg, #F59E0B, #FBBF24); }
                .stat-card.ceo-blue::before { background: linear-gradient(90deg, #3B82F6, #60A5FA); }

                /* Legacy card colors (preserved for other sections) */
                ...
                /* CEO Icon Colors */
                .stat-card.ceo-green .stat-icon { background: rgba(16, 185, 129, 0.12); color: #10B981; }
                .stat-card.ceo-orange .stat-icon { background: rgba(249, 115, 22, 0.12); color: #F97316; }
                .stat-card.ceo-red .stat-icon { background: rgba(239, 68, 68, 0.12); color: #EF4444; }
                .stat-card.ceo-yellow .stat-icon { background: rgba(245, 158, 11, 0.12); color: #F59E0B; }
                .stat-card.ceo-blue .stat-icon { background: rgba(59, 130, 246, 0.12); color: #3B82F6; }
                ...
                .stat-card.ceo-green .stat-value.money {
                    background: linear-gradient(135deg, #10B981, #059669);
                    -webkit-background-clip: text;
                    background-clip: text;
                }

                .stat-card.ceo-red .stat-value.money {
                ...
                .stat-subtitle .trend-up { color: #10B981; font-weight: 600; }
                .stat-subtitle .trend-down { color: #EF4444; font-weight: 600; }
                ...
                .ceo-col-3 { grid-column: span 3; }
                .ceo-col-4 { grid-column: span 4; }
                .ceo-col-5 { grid-column: span 5; }
                .ceo-col-6 { grid-column: span 6; }
                .ceo-col-12 { grid-column: span 12; }
                ...
                .activity-dot.lead { background: #8B5CF6; }
                .activity-dot.new-lead { background: #3B82F6; }
                .activity-dot.approval { background: #10B981; }
                ...
                .status-badge.negotiation { background: rgba(249, 115, 22, 0.12); color: #EA580C; }
                .status-badge.proposal { background: rgba(139, 92, 246, 0.12); color: #7C3AED; }
                .status-badge.meeting { background: rgba(16, 185, 129, 0.12); color: #059669; }
                ...
                .risk-severity.low { background: #DBEAFE; color: #2563EB; }
                ...
                .cal-event:hover { background: var(--border-color); }
                ...
                .cal-date.meeting { background: rgba(139, 92, 246, 0.12); }
                .cal-date.payment { background: rgba(16, 185, 129, 0.12); }
                .cal-date.content { background: rgba(249, 115, 22, 0.12); }
                ...
                .cal-type.meeting { background: rgba(139, 92, 246, 0.12); color: #7C3AED; }
                .cal-type.payment { background: rgba(16, 185, 129, 0.12); color: #059669; }
                .cal-type.content { background: rgba(249, 115, 22, 0.12); color: #EA580C; }
                ...
                .section-title.alerts-title i { background: rgba(239, 68, 68, 0.12); color: #EF4444; }
                .section-title.funnel-title i { background: rgba(139, 92, 246, 0.12); color: #8B5CF6; }
                .section-title.activity-title i { background: rgba(16, 185, 129, 0.12); color: #10B981; }
                .section-title.ops-title i { background: rgba(59, 130, 246, 0.12); color: #3B82F6; }
                .section-title.kpi-title i { background: rgba(249, 115, 22, 0.12); color: #F97316; }
                .section-title.risk-title i { background: rgba(239, 68, 68, 0.12); color: #EF4444; }
                .section-title.calendar-title i { background: rgba(139, 92, 246, 0.12); color: #8B5CF6; }
                .section-title.priority-title i { background: rgba(59, 130, 246, 0.12); color: #3B82F6; }
                ...
                .theme-dark .stat-card.ceo-green .stat-value.money {
                    background: linear-gradient(135deg, #34D399, #10B981);
                    -webkit-background-clip: text;
                    background-clip: text;
                }

                .theme-dark .stat-card.ceo-red .stat-value.money {
                ...
                .theme-dark .alert-critical { background: rgba(239, 68, 68, 0.12); }
                .theme-dark .alert-warning { background: rgba(245, 158, 11, 0.12); }
                .theme-dark .alert-info { background: rgba(59, 130, 246, 0.12); }

                .theme-dark .fab-menu-item {
                    background: var(--bg-card);
                    border-color: var(--border-color);
                    box-shadow: 0 4px 16px rgba(0, 0, 0, 0.3);
                }

                .theme-dark .risk-severity.high { background: rgba(220, 38, 38, 0.2); }
                .theme-dark .risk-severity.medium { background: rgba(217, 119, 6, 0.2); }
                .theme-dark .risk-severity.low { background: rgba(37, 99, 235, 0.2); }
                ...
                @media (max-width: 1100px) {
                    ...
                    .ceo-col-3 { grid-column: span 3; }
                    .ceo-col-4 { grid-column: span 6; }
                    .ceo-col-5 { grid-column: span 6; }
                    .ceo-col-6 { grid-column: span 6; }
                }
                ...
                @media (max-width: 600px) {
                    ...
                    .ceo-col-3, .ceo-col-4, .ceo-col-5, .ceo-col-6, .ceo-col-12 {
                        grid-column: span 1;
                    }
    ...
    loadData: async () => {
        ...
        try {
            ...
            // CEO computed metrics
            // Excluir del overdue los cobros del primer mes (gracia por adelanto)
            const overdueList = (upcomingActions || []).filter(a => !a.completed && a.diffDays < 0 && a.status === 'overdue');
            const overdueTotal = overdueList.reduce((acc, a) => acc + (Number(a.leadTotal) || 0), 0);
            const overdueTotalFormatted = Formatters.toCurrency(overdueTotal, 'BOB');
            const todayList = (upcomingActions || []).filter(a => !a.completed && a.diffDays === 0);
            const hotLeads = allLeads.filter(l => {
                const s = (l.status || '').toLowerCase();
                return s !== 'perdido' && s !== 'abandono' && s !== 'descartado' && s !== 'cerrado' && s !== 'pausa';
            });

            // Priority leads for table (top 5 by value)
            const priorityLeads = [...hotLeads]
                .sort((a, b) => (Number(b.total) || 0) - (Number(a.total) || 0))
                .slice(0, 5);

            // === RENOVACIONES: leads con billing activo ===
            const renewalLeads = allLeads.filter(l => l.billing && l.billing.active);
            let nextRenewalDays = null;
            renewalLeads.forEach(l => {
                const day = l.billing.dayOfMonth || 1;
                const now = new Date();
                let nextDate = new Date(now.getFullYear(), now.getMonth(), day);
                if (nextDate <= now) nextDate.setMonth(nextDate.getMonth() + 1);
                const diff = Math.ceil((nextDate - now) / (1000 * 60 * 60 * 24));
                if (nextRenewalDays === null || diff < nextRenewalDays) nextRenewalDays = diff;
            });
            const renewalSubtitle = nextRenewalDays !== null ? `Próxima en ${nextRenewalDays} día${nextRenewalDays !== 1 ? 's' : ''}` : 'Sin renovaciones activas';

            // === FUNNEL: contar por status real ===
            const funnelTotal = allLeads.length;
            const funnelContactados = allLeads.filter(l => ['contactado'].includes((l.status || '').toLowerCase())).length;
            const funnelInteresados = allLeads.filter(l => ['interesado'].includes((l.status || '').toLowerCase())).length;
            const funnelPropuestas = allLeads.filter(l => ['propuesta', 'negociación', 'negociacion'].includes((l.status || '').toLowerCase())).length;
            const funnelCerrados = allLeads.filter(l => (l.status || '').toLowerCase() === 'cerrado').length;
            const conversionRate = funnelTotal > 0 ? ((funnelCerrados / funnelTotal) * 100).toFixed(1) : '0';
            // Funnel widths proportional
            const fwContact = funnelTotal > 0 ? Math.max(20, Math.round((funnelContactados / funnelTotal) * 100)) : 70;
            const fwInter = funnelTotal > 0 ? Math.max(15, Math.round((funnelInteresados / funnelTotal) * 100)) : 45;
            const fwProp = funnelTotal > 0 ? Math.max(12, Math.round((funnelPropuestas / funnelTotal) * 100)) : 30;
            const fwCerr = funnelTotal > 0 ? Math.max(10, Math.round((funnelCerrados / funnelTotal) * 100)) : 20;

            // === ACTIVIDAD RECIENTE: leads + acciones reales ===
            const recentActivity = [];
            // Leads recientes
            const sortedLeads = allLeads.filter(l => l.createdAt).sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));
            sortedLeads.slice(0, 2).forEach(l => {
                const diffMin = Math.round((Date.now() - new Date(l.createdAt).getTime()) / 60000);
                const timeStr = diffMin < 60 ? `Hace ${diffMin} min` : diffMin < 1440 ? `Hace ${Math.floor(diffMin / 60)}h` : `Hace ${Math.floor(diffMin / 1440)}d`;
                recentActivity.push({ type: 'new-lead', text: `Nuevo lead: ${l.name}`, time: timeStr, source: l.source || '' });
            });
            // Acciones completadas recientemente
            const completedActions = (upcomingActions || []).filter(a => a.completed && a.completedAt).sort((a, b) => {
                const da = a.completedAt ? new Date(a.completedAt) : new Date(0);
                const db = b.completedAt ? new Date(b.completedAt) : new Date(0);
                return db - da;
            });
            completedActions.slice(0, 2).forEach(a => {
                recentActivity.push({ type: 'payment', text: `${a.isBilling ? '💰 Cobro' : '✅ Acción'}: ${a.leadName}`, time: a.completedAt || '' });
            });
            // Si no hay actividad, placeholder
            if (recentActivity.length === 0) {
                recentActivity.push({ type: 'new-lead', text: 'Sin actividad reciente', time: '' });
            }

            // === OPERACIONES HOY: datos reales ===
            const pendingActions = (upcomingActions || []).filter(a => !a.completed);
            const opsFollowups = todayList.length;
            const opsOverdue = overdueList.length;
            const opsNewLeads = allLeads.filter(l => (l.status || '').toLowerCase() === 'nuevo').length;
            const opsProjects = stats.projects || 0;

            // === KPIs DE LEADS: datos reales ===
            const leadsBySource = {};
            allLeads.forEach(l => { const s = l.source || 'Directo'; leadsBySource[s] = (leadsBySource[s] || 0) + 1; });
            const topSourceEntry = Object.entries(leadsBySource).sort((a, b) => b[1] - a[1])[0] || ['N/A', 0];
            const avgLeadValue = allLeads.length > 0 ? (allLeads.reduce((s, l) => s + (Number(l.total) || 0), 0) / allLeads.length) : 0;
            const closedLeads = allLeads.filter(l => (l.status || '').toLowerCase() === 'cerrado').length;
            const closeRate = allLeads.length > 0 ? ((closedLeads / allLeads.length) * 100).toFixed(1) : '0';

            // === CALENDARIO: próximas acciones reales ===
            const calendarEvents = pendingActions
                ...
                .map(a => {
                    ...
                    return { day: d.getDate(), month: meses[d.getMonth()], title: `${a.actionText} — ${a.leadName}`, type: a.isBilling ? 'payment' : 'meeting' };
                });

            // === CLIENTES EN RIESGO: datos reales ===
            const riskClients = [];
            overdueList.slice(0, 3).forEach(a => {
                riskClients.push({ name: a.leadName, issue: `Pago retrasado ${Math.abs(a.diffDays)} días`, severity: 'high', leadId: a.leadId });
            });
            allLeads.filter(l => (l.status || '').toLowerCase() === 'pausa').slice(0, 2).forEach(l => {
                riskClients.push({ name: l.name, issue: 'En pausa — sin actividad', severity: 'medium', leadId: l.id });
            });
            ...
            container.innerHTML = `
                ...
                <!-- ══════════════════════════════════ -->
                <div class="stats-grid">
                    <div class="stat-card ceo-green">
                        <div class="stat-icon"><i class="fas fa-wallet"></i></div>
                        <div class="stat-label">Ingresos del Mes</div>
                        <div class="stat-value money">${revenueFormatted}</div>
                        <div class="stat-subtitle">${stats.leads || 0} leads activos</div>
                    </div>

                    <div class="stat-card ceo-orange">
                        <div class="stat-icon"><i class="fas fa-fire"></i></div>
                        <div class="stat-label">Leads Calientes</div>
                        <div class="stat-value">${hotLeads.length}</div>
                        <div class="stat-subtitle">${todayList.length} requieren seguimiento hoy</div>
                    </div>

                    <div class="stat-card ceo-red">
                        <div class="stat-icon"><i class="fas fa-exclamation-triangle"></i></div>
                        <div class="stat-label">Cobros Vencidos</div>
                        <div class="stat-value money">${overdueTotalFormatted}</div>
                        <div class="stat-subtitle"><span class="trend-down">${overdueList.length} clientes</span> retrasados</div>
                    </div>

                    <div class="stat-card ceo-yellow">
                        <div class="stat-icon"><i class="fas fa-sync-alt"></i></div>
                        <div class="stat-label">Renovaciones</div>
                        <div class="stat-value">${renewalLeads.length}</div>
                        <div class="stat-subtitle">${renewalSubtitle}</div>
                    </div>

                    <div class="stat-card ceo-blue">
                        <div class="stat-icon"><i class="fas fa-chart-bar"></i></div>
                        <div class="stat-label">Pipeline Comercial</div>
                        <div class="stat-value money">${revenueFormatted}</div>
                        <div class="stat-subtitle">${stats.leads || 0} oportunidades activas</div>
                    </div>
                </div>

                <!-- ══════════════════════════════════ -->
                <!-- ROW 2: ALERTS + FUNNEL + ACTIVITY  -->
                <!-- ══════════════════════════════════ -->
                <div class="ceo-row">
                    <!-- Alertas Prioritarias -->
                    <div class="section-card ceo-col-4">
                        <h3 class="section-title alerts-title">
                            <i class="fas fa-bell"></i>
                            Alertas Prioritarias
                        </h3>
                        <div class="alerts-list">
                            ${overdueList.length > 0 ? overdueList.slice(0, 2).map(a => `
                                <div class="alert-item alert-critical">
                                    <i class="fas fa-exclamation-circle"></i>
                                    <span>${a.leadName} → ${Math.abs(a.diffDays)}d retraso</span>
                                    <div class="alert-actions">
                                        <button class="alert-btn btn-ceo-nav" data-lead-id="${a.leadId}">Ver</button>
                                        <button class="alert-btn btn-ceo-whatsapp" data-phone="${a.leadPhone || ''}" data-name="${a.leadName}">Contactar</button>
                                    </div>
                                </div>
                            `).join('') : ''}
                            ${todayList.length > 0 ? `
                                <div class="alert-item alert-warning">
                                    ...
                                    <span>${todayList[0].leadName} — cobro para hoy</span>
                                    <div class="alert-actions">
                                        <button class="alert-btn btn-ceo-nav" data-lead-id="${todayList[0].leadId}">Ver</button>
                                    </div>
                                </div>
                            ` : ''}
                            ${sortedLeads.length > 0 ? `
                                <div class="alert-item alert-info">
                                    ...
                                    <span>Nuevo: ${sortedLeads[0].name}${sortedLeads[0].source ? ' (' + sortedLeads[0].source + ')' : ''}</span>
                                    <div class="alert-actions">
                                        <button class="alert-btn btn-ceo-nav" data-lead-id="${sortedLeads[0].id}">Abrir</button>
                                    </div>
                                </div>
                            ` : ''}
                    ...
                    <!-- Funnel Comercial -->
                    <div class="section-card ceo-col-5">
                        <h3 class="section-title funnel-title">
                            <i class="fas fa-filter"></i>
                            Funnel Comercial
                        </h3>
                        <div class="funnel-container">
                            <div class="funnel-stage" style="width: 100%; background: rgba(59, 130, 246, 0.1); border-left: 4px solid #3B82F6;">
                                <span class="funnel-label">Leads</span>
                                <span class="funnel-value">${funnelTotal}</span>
                            </div>
                            <div class="funnel-stage" style="width: ${fwContact}%; background: rgba(139, 92, 246, 0.1); border-left: 4px solid #8B5CF6;">
                                <span class="funnel-label">Contactados</span>
                                <span class="funnel-value">${funnelContactados}</span>
                            </div>
                            <div class="funnel-stage" style="width: ${fwInter}%; background: rgba(245, 158, 11, 0.1); border-left: 4px solid #F59E0B;">
                                <span class="funnel-label">Interesados</span>
                                <span class="funnel-value">${funnelInteresados}</span>
                            </div>
                            <div class="funnel-stage" style="width: ${fwProp}%; background: rgba(249, 115, 22, 0.1); border-left: 4px solid #F97316;">
                                <span class="funnel-label">Propuestas</span>
                                <span class="funnel-value">${funnelPropuestas}</span>
                            </div>
                            <div class="funnel-stage" style="width: ${fwCerr}%; background: rgba(16, 185, 129, 0.1); border-left: 4px solid #10B981;">
                                <span class="funnel-label">Cerrados</span>
                                <span class="funnel-value">${funnelCerrados}</span>
                            </div>
                        </div>
                    ...
                    <!-- Actividad Reciente -->
                    <div class="section-card ceo-col-3">
                ...
                <!-- ══════════════════════════════════ -->
                <!-- ROW 3: LEADS TABLE + OPS + KPIs    -->
                <!-- ══════════════════════════════════ -->
                <div class="ceo-row">
                    <!-- Leads Prioritarios (Tabla) -->
                    <div class="section-card ceo-col-6">
                        <h3 class="section-title priority-title">
                    ...
                    const s = (lead.status || 'Nuevo').toLowerCase();
                    const tempEmoji = s === 'cerrado' ? '🟢' : s === 'interesado' || s === 'contactado' ? '🟡' : '🔥';
                    const statusClass = s.includes('negoc') ? 'negotiation' : s.includes('propuesta') ? 'proposal' : 'meeting';
                    return `
                                <tr>
                                    <td class="lead-name-cell">${lead.name || 'Sin nombre'}</td>
                                    <td><span class="status-badge ${statusClass}">${lead.status || 'Nuevo'}</span></td>
                                    <td style="font-size:1.2rem; text-align:center;">${tempEmoji}</td>
                                    <td style="font-weight:700; color:#3B82F6;">${Formatters.toCurrency(lead.total || 0, lead.currency || 'BOB')}</td>
                                    <td>
                                        <button class="table-action-btn btn-ceo-whatsapp" data-phone="${lead.phone || ''}" data-name="${lead.name}" title="WhatsApp"><i class="fab fa-whatsapp"></i></button>
                                        <button class="table-action-btn btn-ceo-nav" data-lead-id="${lead.id}" title="Ver"><i class="fas fa-eye"></i></button>
                                    </td>
                                </tr>`;
                }).join('') : `
                                <tr>
                                    <td colspan="5" style="text-align:center; color:var(--text-muted); padding:20px;">Sin leads prioritarios</td>
                                </tr>`}
                            </tbody>
                        </table>
                    </div>
                    ...
                    <!-- Operaciones Hoy -->
                    <div class="section-card ceo-col-3">
                        <h3 class="section-title ops-title">
                            <i class="fas fa-cogs"></i>
                            Operaciones Hoy
                        </h3>
                        <div class="ops-list">
                            <div class="ops-item">
                                <span class="ops-label">Seguimientos hoy</span>
                                <span class="ops-value">${opsFollowups}</span>
                            </div>
                            <div class="ops-item">
                                <span class="ops-label">Cobros vencidos</span>
                                <span class="ops-value" style="${opsOverdue > 0 ? 'color:#EF4444; background:rgba(239,68,68,0.1);' : ''}">${opsOverdue}</span>
                            </div>
                            <div class="ops-item">
                                <span class="ops-label">Leads nuevos</span>
                                <span class="ops-value">${opsNewLeads}</span>
                            </div>
                            <div class="ops-item">
                                <span class="ops-label">Proyectos activos</span>
                                <span class="ops-value">${opsProjects}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- KPIs de Leads -->
                    <div class="section-card ceo-col-3">
                        <h3 class="section-title kpi-title">
                        ...
                        <div class="kpi-list">
                            <div class="kpi-item">
                                ...
                                <span class="kpi-value">${allLeads.length}</span>
                            </div>
                            <div class="kpi-item">
                                <span class="kpi-label">Tasa de cierre</span>
                                <span class="kpi-value">${closeRate}%</span>
                            </div>
                            <div class="kpi-item">
                                <span class="kpi-label">Valor promedio</span>
                                <span class="kpi-value">${Formatters.toCurrency(avgLeadValue, 'BOB')}</span>
                            </div>
                            <div class="kpi-item">
                                <span class="kpi-label">Fuente top</span>
                                <span class="kpi-value" style="font-size:0.82rem;">${topSourceEntry[0]}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ceo-row">
                    ...
                    <div class="section-card ceo-col-6">
                        ...
                        <div class="risk-list">
                            ${riskClients.length > 0 ? riskClients.map(r => `
                                <div class="risk-item ${r.severity}">
                                    <div>
                                        <div class="risk-client">${r.name}</div>
                                        <div class="risk-issue">${r.issue}</div>
                                    </div>
                                    <span class="risk-severity ${r.severity}">${r.severity === 'high' ? 'Alto' : r.severity === 'medium' ? 'Medio' : 'Bajo'}</span>
                                </div>
                            `).join('') : `
                                <div class="alert-item alert-info" style="border-left:4px solid #10B981;background:rgba(16,185,129,0.08);">
                                    <i class="fas fa-check-circle" style="color:#10B981;"></i>
                                    <span>Sin clientes en riesgo ✨</span>
                                </div>
                            `}
                        </div>
                    </div>
                    ...
                    <!-- Calendario -->
                    <div class="section-card ceo-col-6">
                        <h3 class="section-title calendar-title">
                ...
                <div class="fab-container" id="fabContainer">
                    <div class="fab-menu" id="fabMenu">
                        <div class="fab-menu-item" data-fab-route="/leads"><i class="fas fa-user-plus"></i> Nuevo Lead</div>
                        <div class="fab-menu-item" data-fab-route="/quotes"><i class="fas fa-file-invoice-dollar"></i> Nueva Cotización</div>
                        <div class="fab-menu-item" data-fab-route="/leads"><i class="fas fa-money-bill-wave"></i> Registrar Pago</div>
                        <div class="fab-menu-item" data-fab-route="/calendar"><i class="fas fa-tasks"></i> Nueva Tarea</div>
                        <div class="fab-menu-item" data-fab-route="/clients"><i class="fas fa-building"></i> Nuevo Cliente</div>
                    </div>
                    <button class="fab-btn" id="fabMainBtn" title="Acciones rápidas">
        ...
        try {
            ...
            if (overdueActions.length > 0) {
                ...
                overdueActions.forEach(a => {
                    ...
                    const sym = a.leadCurrency === 'USD' ? '$us.' : 'Bs.';
                    let amt = Number(a.leadTotal) || 0;
                    if (a.isFirstMonth && a.billingAdvance > 0) amt = Math.max(0, amt - a.billingAdvance);
                    alertParts.push(`<div style="text-align:left; font-size:0.88rem; padding:4px 0; color:#FCA5A5 !important;">⚠️ ${a.leadName || a.client} — ${days}d de retraso · ${sym} ${amt.toLocaleString('es-ES')}</div>`);
                });
            }
            ...
            if (todayActions.length > 0) {
                ...
                todayActions.forEach(a => {
                    ...
                    let amt = Number(a.leadTotal) || 0;
                    if (a.isFirstMonth && a.billingAdvance > 0) amt = Math.max(0, amt - a.billingAdvance);
                    alertParts.push(`<div style="text-align:left; font-size:0.88rem; padding:4px 0; color:#FCD34D !important;">📅 ${a.leadName || a.client} · ${sym} ${amt.toLocaleString('es-ES')}</div>`);
                });
            }
        ...
        DashboardModule.bindFAB();
        DashboardModule.bindCEOButtons();
    },
    ...
    renderActions: () => {
        ...
        container.innerHTML = filtered.map((action, filteredIdx) => {
            ...
            if (!action.completed) {
                ...
                else if (action.diffDays < 0 && action.status === 'overdue') labelText = `${Math.abs(action.diffDays)}d vencida`;
                else if (action.diffDays < 0 && action.status === 'soon') labelText = 'Primer mes';
            } else {
                labelText = `✓ ${dateStr}`;
            }
            ...
            // Para el primer mes, descontar el adelanto del monto mostrado
            let displayAmount = action.leadTotal || 0;
            if (isBilling && action.isFirstMonth && action.billingAdvance > 0) {
                displayAmount = Math.max(0, displayAmount - action.billingAdvance);
            }
            const amountShort = isBilling && displayAmount ? `${currSymbol}${Number(displayAmount).toLocaleString('es-BO')}` : '';
            ...
            if (action.completed) {
                ...
                if (isBilling) {
                    // Billing pendiente: ojo para recibo + botón con monto
                    actionBtns = `
                        <div style="display:flex; gap:6px; align-items:center;">
                            <button class="btn-receipt-action" data-action-idx="${filteredIdx}" style="width:36px;height:36px;border:1px solid #D1D5DB;background:#EFF6FF;border-radius:8px;cursor:pointer;font-size:1rem;" title="Ver Recibo PDF">👁️</button>
            ...
            const delayInfo = !action.completed && action.diffDays < 0 && action.status === 'overdue'
        ...
        // Bind receipt buttons (👁️) - billing (completado y pendiente)
    ...
    generateReceipt: async (action) => {
        ...
        // Datos del recibo
        const currSymbol = action.leadCurrency === 'USD' ? '$us.' : 'Bs.';
        const fullAmount = Number(action.leadTotal || 0);
        const advanceAmount = (action.isFirstMonth && action.billingAdvance > 0) ? Number(action.billingAdvance) : 0;
        const rawAmount = Math.max(0, fullAmount - advanceAmount);
    ...
    <div class="page">
        ...
        <div class="content">
            ...
            <div class="amount-section">
                ${hasAdvance ? `
                <div style="margin-bottom:14px; padding-bottom:14px; border-bottom:1px dashed #BBF7D0;">
                    <div style="display:flex; justify-content:space-between; font-size:0.88rem; color:#475569; margin-bottom:6px;">
                        ...
                        <span style="font-weight:700;">${currSymbol} ${fullAmount.toLocaleString('es-BO', { minimumFractionDigits: 2 })}</span>
                    </div>
                    <div style="display:flex; justify-content:space-between; font-size:0.88rem; color:#D97706; margin-bottom:6px;">
                        <span>Adelanto recibido${action.billingAdvanceConcept ? ' (' + action.billingAdvanceConcept + ')' : ''}:</span>
                        <span style="font-weight:700;">- ${currSymbol} ${advanceAmount.toLocaleString('es-BO', { minimumFractionDigits: 2 })}</span>
                    </div>
                </div>
                <div class="section-label" style="text-align:center; margin-bottom:6px;">SALDO PENDIENTE</div>
                ` : `
...
<body>
    ...
    // Bind del FAB (Floating Action Button)
    bindFAB: () => {
        ...
        // Navegación desde items del FAB
        menu.querySelectorAll('[data-fab-route]').forEach(item => {
            item.addEventListener('click', () => {
                const route = item.dataset.fabRoute;
    ...
    // Bind de botones CEO (Ver, Contactar, WhatsApp en alertas y tabla)
    bindCEOButtons: () => {
        // Botones "Ver" → navegar al lead
        document.querySelectorAll('.btn-ceo-nav').forEach(btn => {
            btn.addEventListener('click', () => {
                const leadId = btn.dataset.leadId;
                if (leadId && window.navigateTo) {
                    window.navigateTo('/leads');
                }
            });
        });

        // Botones "Contactar" / "WhatsApp" → abrir WhatsApp
        document.querySelectorAll('.btn-ceo-whatsapp').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                if (phone) {
                    ...
                    const msg = encodeURIComponent(`Hola ${name}, le escribo desde Magic Design Efecto.`);
                    window.open(`https://wa.me/${fullPhone}?text=${msg}`, '_blank');
                } else {
                    if (typeof Swal !== 'undefined') {
                        Swal.fire({ icon: 'info', title: 'Sin teléfono', text: `${name} no tiene teléfono registrado`, timer: 2500 });
                    }
                }
            });
        });
